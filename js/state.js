...
// Fórmula: 50 * n^1.260 → suma total ~50.041 XP en 30 niveles
// Nivel 1→2: 50 XP · Nivel 30: 3.632 XP · Clase completa: ~50.000 XP
export const xpParaNivel = (n) => Math.round(50 * Math.pow(n, 1.260));
